                  ...
                  >
                    <div
                      style={{
                        ...
                        overflow: "hidden",
                        background:
                          p.profilePicture || getPlayerPhoto(p.id)
                            ? "transparent"
                            : "var(--bg-elevated)",
                        display: "flex",
                        alignItems: "center",
              ...
              {stats.ranking.map((p, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {p.matchesPlayed} partidos • {p.matchesWon} victorias •
                      Dif: {p.pointDifference}
                    </p>
                  </div>
              ...
              {stats.completedMatchesList.map((match, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {renderTeam(match.team1, team1Wins)}
                      ...
                      {renderTeam(match.team2, !team1Wins)}
                    </div>
                  </div>
                );
              })}
